<?php
/**
 * Register a custom post type called "maintenance".
 *
...
function project_theme_init_post_types() {
    ...
    $labels = array(
        ...
        'add_new_item'          => esc_html__( 'Add New Maintenace', 'project_theme' ),
        'new_item'              => esc_html__( 'New Maintenance', 'project_theme' ),
